...
productArr[5] = new products(
    'hat05', 'Pikachu Poké Plush Hat', '400000₫', '350000₫', '../img/hat/hat05/hat05_1.jpg', 'co', 'Pikachu Poké Plush Hat picture', 'Con xai duoc', 'chua hu' 
)
...
productArr[14] = new products(
    'hat14', 'Pikachu Poké Plush Hat', '400000₫', '350000₫', '../img/hat/hat14/hat14_1.jpg', 'co', 'Pikachu Poké Plush Hat picture', 'Con xai duoc', 'chua hu' 
)
...
productArr[22] = new products(
    'shi02', 'Super Printed Shirt', '400000₫', '300000₫', '../img/shi/shi02/shi02_1.jpg', 'co', 'Super Printed Shirt picture', 'Con xai duoc', 'van chua hu' 
)
...
productArr[27] = new products(
    'shi07', 'Super Printed Shirt', '400000₫', '300000₫', '../img/shi/shi07/shi07_1.jpg', 'co', 'Super Printed Shirt picture', 'Con xai duoc', 'van chua hu' 
)
productArr[28] = new products(
    'shi08', 'Super Printed Shirt', '400000₫', '300000₫', '../img/shi/shi08/shi08_1.jpg', 'co', 'Super Printed Shirt picture', 'Con xai duoc', 'van chua hu' 
)
...
productArr[30] = new products(
    'shi10', 'Super Printed Shirt', '400000₫', '300000₫', '../img/shi/shi10/shi10_1.jpg', 'co', 'Super Printed Shirt picture', 'Con xai duoc', 'van chua hu' 
)
productArr[31] = new products(
    'shi11', 'Super Printed Shirt', '400000₫', '300000₫', '../img/shi/shi11/shi11_1.jpg', 'co', 'Super Printed Shirt picture', 'Con xai duoc', 'van chua hu' 
)
...
productArr[41] = new products(
    'plu01', 'Super Cute Suffed Animal', '400000₫', '380000₫', '../img/plu/plu01/plu01_1.jpg', 'co', 'Super Cute Suffed Animal picture', 'Con xai duoc', 'van chua hu' 
)
...
productArr[43] = new products(
    'plu03', 'Super Cute Suffed Animal', '400000₫', '380000₫', '../img/plu/plu03/plu03_1.jpg', 'co', 'Super Cute Suffed Animal picture', 'Con xai duoc', 'van chua hu' 
)
productArr[44] = new products(
    'plu04', 'Super Cute Suffed Animal', '400000₫', '380000₫', '../img/plu/plu04/plu04_1.jpg', 'co', 'Super Cute Suffed Animal picture', 'Con xai duoc', 'van chua hu' 
)
...
productArr[48] = new products(
    'plu08', 'Super Cute Suffed Animal', '400000₫', '380000₫', '../img/plu/plu08/plu08_1.jpg', 'co', 'Super Cute Suffed Animal picture', 'Con xai duoc', 'van chua hu' 
)
...
productArr[55] = new products(
    'plu15', 'Super Cute Suffed Animal', '400000₫', '380000₫', '../img/plu/plu15/plu15_1.jpg', 'co', 'Super Cute Suffed Animal picture', 'Con xai duoc', 'van chua hu' 
)
productArr[56] = new products(
    'plu16', 'Super Cute Suffed Animal', '400000₫', '380000₫', '../img/plu/plu16/plu16_1.jpg', 'co', 'Super Cute Suffed Animal picture', 'Con xai duoc', 'van chua hu' 
)
productArr[57] = new products(
    'plu17', 'Super Cute Suffed Animal', '400000₫', '380000₫', '../img/plu/plu17/plu17_1.jpg', 'co', 'Super Cute Suffed Animal picture', 'Con xai duoc', 'van chua hu' 
)
...
productArr[59] = new products(
    'plu19', 'Super Cute Suffed Animal', '400000₫', '380000₫', '../img/plu/plu19/plu19_1.jpg', 'co', 'Super Cute Suffed Animal picture', 'Con xai duoc', 'van chua hu' 
)
productArr[60] = new products(
    'fig00', 'Amazing Figure', '460000₫', '330000₫', '../img/fig/fig00/fig00_1.jpg', 'co', 'Amazing Figure picture', 'Con xai duoc', 'van chua hu' 
)
...
productArr[68] = new products(
    'fig07', 'Amazing Figure', '460000₫', '330000₫', '../img/fig/fig07/fig07_1.jpg', 'co', 'Amazing Figure picture', 'Con xai duoc', 'van chua hu' 
)
...
productArr[73] = new products(
    'fig12', 'Amazing Figure', '460000₫', '330000₫', '../img/fig/fig12/fig12_1.jpg', 'co', 'Amazing Figure picture', 'Con xai duoc', 'van chua hu' 
)
...
productArr[77] = new products(
    'fig16', 'Amazing Figure', '460000₫', '330000₫', '../img/fig/fig16/fig16_1.jpg', 'co', 'Amazing Figure picture', 'Con xai duoc', 'van chua hu' 
)
productArr[78] = new products(
    'fig17', 'Amazing Figure', '460000₫', '330000₫', '../img/fig/fig17/fig17_1.jpg', 'co', 'Amazing Figure picture', 'Con xai duoc', 'van chua hu' 
)
...
function addProduct(position,productList,categoryUrl,baseUrl){
    ...
    for(let i = position; i < productList.length; i++){
        ...
        "<p>" + "</span>" + "<span class='fix-price-highlight'>" + productList[i].fixPrice + "</span>" + "<span class='price-deco'>" + productList[i].firstPrice  +"</p>" +
        "</div>"+
        '</div>';
        if(count == 8){
            break;
